...
<div align="center">
   ...
   <h1>Nyx - Advanced AI Assistant</h1>
</div>

<p align="center">
Powered by Alsania - Bringing advanced AI capabilities to ChatGPT, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, Kimi, Github Copilot, Mistral and more...
</p>
...
<div align="center">
   <a href="https://chromewebstore.google.com/detail/nyx-advanced-ai-assistant/kngiafgkdnlkgmefdafaibkibegkcaef?hl=en">
   ...
   <a href="https://addons.mozilla.org/en-US/firefox/addon/nyx-advanced-ai-assistant/">
...
Nyx is a Chrome extension that integrates the Model Context Protocol (MCP) tools with AI platforms like Perplexity, ChatGPT, Google Gemini, Google AI Studio, Grokand more. It allows users to execute MCP tools directly from these platforms and insert the results back into the conversation, enhancing the capabilities of web-based AI assistants.
...
#### Run Nyx Proxy via npx:
   ...
   ```bash
   npx @alsania/nyx-proxy@latest --config ./config.json
   ```
...
#### Release Version
1. Download the latest release from [Releases](https://github.com/alsania/nyx/releases)
...
- Powered by [Alsania](https://alsania.com) - Advancing the future of AI technology

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=alsania/nyx&type=Date)](https://star-history.com/#alsania/nyx&Date)