...
<div align="center">
   ...
   <h1>Nyx AI Assistant Chrome Extension</h1>
</div>

<p align="center">
Nyx brings MCP to ChatGPT, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, Kimi, Github Copilot, Mistral and more...
</p>
...
Nyx is a Chrome extension by Alsania that integrates the Model Context Protocol (MCP) tools with AI platforms like Perplexity, ChatGPT, Google Gemini, Google AI Studio, Grokand more. It allows users to execute MCP tools directly from these platforms and insert the results back into the conversation, enhancing the capabilities of web-based AI assistants.
...
#### Release Version
1. Download the latest release from [Releases](https://github.com/SigmaSauer07/nyx/releases)
...
[![Star History Chart](https://api.star-history.com/svg?repos=alsania/nyx&type=Date)](https://www.star-history.com/#alsania/nyx&Date)