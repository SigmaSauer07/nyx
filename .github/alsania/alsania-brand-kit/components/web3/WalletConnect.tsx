...
export const WalletConnect: React.FC<WalletConnectProps> = ({
  ...
  if (walletInfo) {
    return (
      <div className={`alsania-wallet alsania-wallet--connected ${className}`}>
        <div className="alsania-wallet__info">
          <div className="alsania-wallet__address">
            {formatAddress(walletInfo.address)}
          </div>
          <div className="alsania-wallet__network">
            {walletInfo.network}
          </div>
          <div className="alsania-wallet__balance">
  ...
  return (
    <div className={`alsania-wallet ${className}`}>
      {error && (
        <div className="alsania-wallet__error">
          {error}
        </div>
      )}
      <button
        className="alsania-btn alsania-btn--primary"
        onClick={connectWallet}
        disabled={isConnecting}
      >
        {isConnecting ? (
          <>
            <span className="alsania-spinner"></span>
            Connecting...
          </>
        ) : (
          <>
            <span className="alsania-ui-icon alsania-ui-icon--wallet"></span>
            Connect Wallet
          </>
        )}
      </button>
