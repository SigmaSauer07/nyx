...
export const Icon: React.FC<IconProps> = ({
  ...
  const baseClass = 'Nyx-icon';
  const sizeClass = `Nyx-icon--${size}`;
  const colorClass = color ? `Nyx-icon--${color}` : '';
  const stateClasses = [
    disabled && 'Nyx-icon--disabled',
    loading && 'Nyx-icon--loading',
    spin && 'Nyx-icon--spin',
    pulse && 'Nyx-icon--pulse',
    bounce && 'Nyx-icon--bounce',
    glow && 'Nyx-icon--glow',
    hover && 'Nyx-icon--hover',
    background && 'Nyx-icon--bg',
    bordered && 'Nyx-icon--bordered',
    shadow && 'Nyx-icon--shadow',
  ].filter(Boolean).join(' ');
